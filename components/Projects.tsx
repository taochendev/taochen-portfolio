...
const projects = [
  {
    ...
    tech: ["Python", "Node.js", "AWS Lambda/ECS", "Redis", "Kafka", "FFMPEG", "GPU pipelines"],
  },
  {
    ...
    tech: ["TypeScript", "Google Calendar API", "Slack API", "WebRTC", "Python", "FastAPI"],
  },
  {
    ...
    tech: ["Golang", "Python", "Dgraph", "MQTT", "Prometheus", "Kubernetes", "Docker"],
  },
  {
